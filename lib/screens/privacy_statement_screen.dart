        ...
        appBar: AppBar(
          title: const Text(
            ...
            style: TextStyle(
              ...
              color: Colors.white, // Adjust title color for readability
            ),
          ),
          centerTitle: true,
            ...
            children: const [
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      '• Personal Information: This may include your name, email address, and other details you provide when creating an account or using the app\'s features.',
                      style: TextStyle(fontSize: 14, color: Colors.white),
                    ),
                    Text(
                      '• Financial Data: For users tracking their expenses and managing their budget, we may collect transaction details, categorized expenses, and financial goals.',
                      style: TextStyle(fontSize: 14, color: Colors.white),
                    ),
                    Text(
                      '• Usage Data: This includes information about how you use the app, such as interaction patterns, features accessed, and preferences.',
                      style: TextStyle(fontSize: 14, color: Colors.white),
                    ),
                  ],
                ),
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      '• To Provide Services: To help you track and manage your finances, categorize your expenses, set budgeting goals, and visualize your financial data.',
                      style: TextStyle(fontSize: 14, color: Colors.white),
                    ),
                    Text(
                      '• Improvement of Services: To enhance the functionality of the app and improve user experience through continuous feedback and updates.',
                      style: TextStyle(fontSize: 14, color: Colors.white),
                    ),
                    Text(
                      '• Personalization: To provide a personalized experience and recommend features based on your use and data.',
                      style: TextStyle(fontSize: 14, color: Colors.white),
                    ),
                    Text(
                      '• Communication: To inform you about updates, new features, or changes to the app\'s services.',
                      style: TextStyle(fontSize: 14, color: Colors.white),
                    ),
                  ],
                ),
